...
func TestPrecinctComplianceEvidence_JSON(t *testing.T) {
...
func TestPrecinctComplianceEvidence_TableDefault(t *testing.T) {
	orig := complianceCollectControlEvidence
	t.Cleanup(func() { complianceCollectControlEvidence = orig })
...
func TestPrecinctComplianceEvidence_ControlRequired(t *testing.T) {
	var stdout, stderr bytes.Buffer
	code := run(
...
func TestPrecinctComplianceEvidence_OpenSearchRequiresSecretMaterial(t *testing.T) {
	var stdout, stderr bytes.Buffer
	code := run(

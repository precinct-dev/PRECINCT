...
type fakeSPIKEManager struct {
	listRefs []precinctcli.SPIKESecretRef
	listErr  error

	putResult precinctcli.SPIKESecretPutResult
	putErr    error
	putRef    string
	putValue  string
}

func (f *fakeSPIKEManager) ListSecretRefs(_ context.Context) ([]precinctcli.SPIKESecretRef, error) {
	if f.listErr != nil {
...
func (f *fakeSPIKEManager) PutSecret(_ context.Context, ref, value string) (precinctcli.SPIKESecretPutResult, error) {
	f.putRef = ref
	f.putValue = value
	if f.putErr != nil {
		return precinctcli.SPIKESecretPutResult{}, f.putErr
	}
...
func TestPrecinctSecretPut_ConfirmRequired(t *testing.T) {
...
func TestPrecinctSecretList_JSON(t *testing.T) {
...
func TestPrecinctSecretList_TableDefault(t *testing.T) {
	withFakeSPIKEManager(t, &fakeSPIKEManager{
		listRefs: []precinctcli.SPIKESecretRef{
			{Ref: "deadbeef", Created: "-", Type: "string"},
		},
...
func TestPrecinctSecretPut_SuccessAndNoValueLeak(t *testing.T) {
...
func TestPrecinctSecretList_ErrorPropagates(t *testing.T) {
	withFakeSPIKEManager(t, &fakeSPIKEManager{

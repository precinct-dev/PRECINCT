...
const (
	...
	ReasonModelMissionScopeDenied      ReasonCode = "MODEL_MISSION_SCOPE_DENIED"
	ReasonModelMissionScopeFallback    ReasonCode = "MODEL_MISSION_SCOPE_SAFE_FALLBACK_APPLIED"

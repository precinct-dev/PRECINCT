...
const (
	...
	ReasonContextFactsCSVValidation     ReasonCode = "CONTEXT_FACTS_CSV_VALIDATION_FAILED"
	ReasonContextFactsProvenanceInvalid ReasonCode = "CONTEXT_FACTS_PROVENANCE_INVALID"

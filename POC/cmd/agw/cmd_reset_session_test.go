...
func TestAgwResetSession_AllWithoutConfirm_Fails(t *testing.T) {
...
func TestAgwResetSession_PromptNo_Aborts(t *testing.T) {
	var stdout, stderr bytes.Buffer
	code := run(
...
func TestAgwResetSession_PromptYes_DeletesSPIFFEKeys(t *testing.T) {
...
func TestAgwResetSession_AllConfirm_JSON(t *testing.T) {
	mr, err := miniredis.Run()
	if err != nil {
		t.Fatalf("miniredis: %v", err)
	}

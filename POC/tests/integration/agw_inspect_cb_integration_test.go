...
func TestAgwInspectCircuitBreakerIntegration_JSON(t *testing.T) {
	...
	if err := cmd.Run(); err != nil {
		t.Fatalf("agw inspect circuit-breaker failed: %v stdout=%q stderr=%q", err, stdout.String(), stderr.String())
	}

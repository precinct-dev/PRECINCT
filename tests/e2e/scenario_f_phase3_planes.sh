    ...
    gateway_post "/v1/model/call" "{
      ...
      \"policy\": {
        ...
        \"attributes\": {
          ...
          \"model\": \"gpt-4o\",
          \"prompt_has_phi\": true,
          \"prompt\": \"Patient chart includes regulated health information flagged for review.\"
        }
      }
    }" "${SPIFFE_ID}"
...
gateway_post "/v1/context/admit" "{
  ...
  \"policy\": {
    ...
    \"attributes\": {
      ...
      \"content\": \"Patient chart with regulated PHI classification pending review\",
      \"provenance\": {
        \"source\": \"ingress\",
        \"checksum\": \"sha256:context\",
        \"verified\": true,
...
gateway_post "/v1/model/call" "{
  ...
  \"policy\": {
    ...
    \"attributes\": {
      ...
      \"prompt_has_phi\": true,
      \"prompt_action\": \"deny\",
      \"prompt\": \"Patient record with regulated health information flagged for review\"
    }
  }
}" "${SPIFFE_ID}"

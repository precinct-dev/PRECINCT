...
class SQLiteCache:
    """Small sqlite-backed cache used in place of diskcache."""
    ...
    def __setitem__(self, key: str, value: Any) -> None:
        ...
        with self._lock:
            self._conn.execute(
                """
                INSERT INTO cache_entries(key, value, size_bytes, updated_at)
                VALUES (?, ?, ?, ?)
    ...
    def _prune_if_needed(self) -> None:
        ...
        while total > self.size_limit_bytes:
...
class Cache:
    ...
    `Cache` provides 2 levels of caching (in the given order):
        ...
        2. On-disk cache - implemented with a sqlite-backed cache
    """
    ...
    def __init__(
        ...
        if self.enable_disk_cache:
            self.disk_cache = SQLiteCache(
                ...
                size_limit_bytes=disk_size_limit_bytes,
            )
        else:
            self.disk_cache = {}
